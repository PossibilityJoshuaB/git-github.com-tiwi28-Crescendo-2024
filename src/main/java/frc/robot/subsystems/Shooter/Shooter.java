...
public class Shooter extends SubsystemBase {
  private final CANSparkMax leader = new CANSparkMax(Constants.ShooterConstants.id, MotorType.kBrushless);
  ...
  public void setupMotor() {
    ...
    encoder.setVelocityConversionFactor(1); // TODO: don't know what it will be
