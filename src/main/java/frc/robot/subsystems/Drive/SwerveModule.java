...
public class SwerveModule {
  ...
  public void updateDashboardValues() {
    SmartDashboard.putNumber(Constants.SwerveConstants.moduleNames[this.moduleNumber] + " Integrated Encoder",
        this.getState().angle.getDegrees());
    SmartDashboard.putNumber(Constants.SwerveConstants.moduleNames[this.moduleNumber] + " Can Coder",
        this.angleEncoder.getAbsolutePosition().getDegrees());
    SmartDashboard.putNumber(Constants.SwerveConstants.moduleNames[this.moduleNumber] + " Set Point", this.lastAngle);
    SmartDashboard.putNumber(Constants.SwerveConstants.moduleNames[this.moduleNumber] + " Drive Encoder Velocity",
